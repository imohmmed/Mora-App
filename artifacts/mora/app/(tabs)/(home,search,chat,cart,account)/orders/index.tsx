...
const styles = StyleSheet.create({
  ...
  pageTitleWeb:    { fontFamily: "Cairo_900Black", fontSize: 22, fontWeight: "900", letterSpacing: -0.4, flex: 1, paddingHorizontal: 8 },
  ...
  orderNum:        { fontFamily: "Cairo_600SemiBold", fontSize: 14 },
  orderDate:       { fontFamily: "Cairo_400Regular", fontSize: 12, marginTop: 2 },
  statusBadge:     { flexDirection: "row", alignItems: "center", gap: 5, paddingHorizontal: 10, paddingVertical: 4, borderRadius: 4 },
  statusTxt:       { fontFamily: "Cairo_600SemiBold", fontSize: 12 },
  orderCardBottom: { alignItems: "center", paddingHorizontal: 14, paddingVertical: 10, borderTopWidth: 1, justifyContent: "space-between" },
  orderItems:      { fontFamily: "Cairo_400Regular", fontSize: 13 },
  orderTotal:      { fontFamily: "Cairo_700Bold", fontSize: 14 },
