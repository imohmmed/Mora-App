...
const styles = StyleSheet.create({
  ...
  comeOnIn:     { fontFamily: "Cairo_700Bold", fontSize: 22, letterSpacing: 1, textAlign: "center" },
  comeOnInSub:  { fontFamily: "Cairo_400Regular", fontSize: 14, textAlign: "center", lineHeight: 20 },
  authBtns:     { width: "100%", gap: 12, marginTop: 8 },
  signInBtn:    { width: "100%", paddingVertical: 16, alignItems: "center", borderRadius: 0 },
  signInBtnText:{ fontFamily: "Cairo_700Bold", fontSize: 14, letterSpacing: 1 },
  joinBtn:      { width: "100%", paddingVertical: 15, alignItems: "center", borderRadius: 0, borderWidth: 1 },
  joinBtnText:  { fontFamily: "Cairo_700Bold", fontSize: 14, letterSpacing: 1 },
  helpRow:      { flexDirection: "row", alignItems: "center", gap: 6, position: "absolute" },
  helpText:     { fontFamily: "Cairo_400Regular", fontSize: 14 },

  /* ── Auth form ── */
  formScroll: { padding: 20, gap: 0 },
  formRow:    { marginBottom: 16 },
  label:      { fontFamily: "Cairo_500Medium", fontSize: 13, marginBottom: 6 },
  input:      { borderWidth: 1, borderRadius: 0, paddingHorizontal: 14, paddingVertical: 12, fontFamily: "Cairo_400Regular", fontSize: 15 },
  passWrap:   { position: "relative" },
  passInput:  { paddingRight: 46 },
  eyeBtn:     { position: "absolute", right: 12, top: 12 },
  errorBox:   { flexDirection: "row", alignItems: "center", gap: 8, padding: 12, borderRadius: 0, borderWidth: 1, marginBottom: 16 },
  errorMsg:   { color: "#DC2626", fontFamily: "Cairo_400Regular", fontSize: 13, flex: 1 },
  submitBtn:  { paddingVertical: 16, alignItems: "center", borderRadius: 0, marginTop: 8 },
  submitBtnText: { fontFamily: "Cairo_700Bold", fontSize: 14, letterSpacing: 1 },

  /* ── Account main ── */
  profileCard:  { margin: 16, padding: 16, borderRadius: 16, flexDirection: "row", alignItems: "center", gap: 14 },
  avatar:       { width: 56, height: 56, borderRadius: 28, alignItems: "center", justifyContent: "center" },
  avatarText:   { color: "#fff", fontFamily: "Cairo_700Bold", fontSize: 20 },
  ...
  memberBadgeText: { fontFamily: "Cairo_700Bold", fontSize: 10, letterSpacing: 0.5 },
  ...
  starBadgeText:{ fontFamily: "Cairo_700Bold", fontSize: 10, letterSpacing: 0.5, color: "#1A1A1A" },
  ...
  menuLabel:    { fontFamily: "Cairo_500Medium", fontSize: 15 },
  badgePill:    { paddingHorizontal: 7, paddingVertical: 2, borderRadius: 10, minWidth: 20, alignItems: "center" },
  badgePillTxt: { color: "#fff", fontSize: 11, fontFamily: "Cairo_700Bold" },
  ...
  signOutTxt: { color: "#DC2626", fontFamily: "Cairo_600SemiBold", fontSize: 14 },
